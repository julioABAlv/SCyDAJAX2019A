<?php
 ...
 if (isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
  ...
  HTML::cabeceras(array('title'      =>'Pruebas LIGA 3',
			...
			'css'        =>array('css/LIGA.css','css/jquery-ui/liga/jquery-ui-1.9.2.liga.min.css'),
 ...
 $cont = ob_get_clean();
  ...
  // Cierre de etiquetas HTML
		$metodo = array('js'=>array('js/jquery-3.1.1.min.js','js/jquery.liga-1.3.13.js','js/codigo.js','js/jquery-ui.min.js'));
  HTML::pie($metodo);
?>